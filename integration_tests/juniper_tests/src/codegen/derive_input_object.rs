use fnv::FnvHashMap;
use juniper::{
    execute, graphql_input_value, graphql_object, graphql_value, graphql_vars, marker,
    DefaultScalarValue, FieldError, FromInputValue, GraphQLInputObject, GraphQLType, GraphQLValue,
