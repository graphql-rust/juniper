...
impl<'a> OverlappingFieldsCanBeMerged<'a> {
    fn find_conflicts_within_selection_set(&self,
        ...
        for (i, frag_name1) in fragment_names.iter().enumerate() {
            self.collect_conflicts_between_fields_and_fragment(&mut conflicts,
                                                               &field_map,
                                                               frag_name1,
                                                               false,
                                                               ctx);
            ...
            for frag_name2 in &fragment_names[i + 1..] {
                self.collect_conflicts_between_fragments(&mut conflicts,
                                                         frag_name1,
                                                         frag_name2,
                                                         false,
                                                         ctx);
    ...
    fn collect_conflicts_between_fragments(&self,
        ...
        self.collect_conflicts_between(conflicts,
                                       mutually_exclusive,
                                       &field_map1,
                                       &field_map2,
                                       ctx);
        ...
        for fragment_name2 in &fragment_names2 {
            self.collect_conflicts_between_fragments(conflicts,
                                                     fragment_name1,
                                                     fragment_name2,
                                                     mutually_exclusive,
                                                     ctx);
    ...
    fn collect_conflicts_between_fields_and_fragment(&self,
                                                     conflicts: &mut Vec<Conflict>,
        ...
        for fragment_name2 in fragment_names2 {
            self.collect_conflicts_between_fields_and_fragment(conflicts,
                                                               field_map,
                                                               fragment_name2,
                                                               mutually_exclusive,
                                                               ctx);
    ...
    fn collect_conflicts_between(&self,
                                 conflicts: &mut Vec<Conflict>,
                                 mutually_exclusive: bool,
            ...
            if let Some(fields2) = field_map2.get(response_name) {
                for field1 in fields1 {
                    for field2 in fields2 {
                        if let Some(conflict) = self.find_conflict(response_name,
                                                                   field1,
                                                                   field2,
                                                                   mutually_exclusive,
                                                                   ctx) {
    ...
    fn collect_conflicts_within(&self,
                                conflicts: &mut Vec<Conflict>,
                                field_map: &AstAndDefCollection<'a>,
                                ctx: &ValidatorContext<'a>) {
    ...
    fn find_conflict(&self,
        ...
        if !mutually_exclusive {
            ...
            if name1 != name2 {
                return Some(Conflict(ConflictReason(response_name.to_owned(),
        ...
        if let (&Some(ref s1), &Some(ref s2)) =
            ...
            let conflicts =
                self.find_conflicts_between_sub_selection_sets(mutually_exclusive,
    ...
    fn find_conflicts_between_sub_selection_sets(&self,
                                                 mutually_exclusive: bool,
        ...
        self.collect_conflicts_between(&mut conflicts,
                                       mutually_exclusive,
                                       &field_map1,
                                       &field_map2,
                                       ctx);
    ...
    fn subfield_conflicts(&self,
        ...
        Some(Conflict(ConflictReason(response_name.to_owned(),
                                     ConflictReasonMessage::Nested(conflicts
                                                                       .iter()
                                                                       .map(|c| {
                                                                                c.0.clone()
                                                                            })
    ...
    fn is_same_arguments(&self,
        ...
        match (args1, args2) {
            ...
            (&Some(Spanning { item: ref args1, .. }), &Some(Spanning { item: ref args2, .. })) => {
                ...
                args1
                    .iter()
                    .all(|&(ref n1, ref v1)| if let Some(&(_, ref v2)) =
    ...
    fn get_referenced_fields_and_fragment_names(&self,
                                                fragment: &'a Fragment,
                                                ctx: &ValidatorContext<'a>)
    ...
    fn get_fields_and_fragment_names(&self,
                                     parent_type: Option<&'a MetaType>,
                                     selection_set: &'a [Selection],
                                     ctx: &ValidatorContext<'a>)
                                     -> (AstAndDefCollection<'a>, Vec<&'a str>) {
        ...
        self.collect_fields_and_fragment_names(parent_type,
                                               selection_set,
                                               ctx,
                                               &mut ast_and_defs,
                                               &mut fragment_names);
    ...
    fn collect_fields_and_fragment_names(&self,
                                         parent_type: Option<&'a MetaType>,
                                         selection_set: &'a [Selection],
                                         ctx: &ValidatorContext<'a>,
...
mod tests {
    ...
    fn encounters_conflict_in_fragments() {
        ...
        "#,
                          &[RuleError::new(&error_message("x",
                                                          &Message("a and b are different fields"
                                                                       .to_owned())),
    ...
    fn reports_each_conflict_once() {
        ...
        "#,
                          &[RuleError::new(&error_message("x",
                                                          &Message("c and a are different fields"
                                                                       .to_owned())),
                                           &[SourcePosition::new(220, 13, 14),
                                             SourcePosition::new(294, 17, 12)]),
                            RuleError::new(&error_message("x",
                                                          &Message("c and b are different fields"
                                                                       .to_owned())),
                                           &[SourcePosition::new(220, 13, 14),
    ...
    fn deep_conflict() {
        ...
        "#,
                          &[RuleError::new(&error_message("field",
                                                          &Nested(vec![
                            ConflictReason(
                                "x".to_owned(),
    ...
    fn reports_deep_conflict_to_nearest_common_ancestor() {
        ...
        "#,
                          &[RuleError::new(&error_message("deepField",
                                                          &Nested(vec![
                            ConflictReason(
                                "x".to_owned(),
                                Message("a and b are different fields".to_owned())
    ...
    impl GraphQLType for SomeBox {
        ...
        fn meta<'r>(registry: &mut Registry<'r>) -> MetaType<'r> {
            let fields = &[registry.field::<Option<SomeBox>>("deepBox"),
    ...
    impl GraphQLType for StringBox {
        ...
        fn meta<'r>(registry: &mut Registry<'r>) -> MetaType<'r> {
            let fields = &[registry.field::<Option<String>>("scalar"),
    ...
    impl GraphQLType for IntBox {
        ...
        fn meta<'r>(registry: &mut Registry<'r>) -> MetaType<'r> {
            let fields = &[registry.field::<Option<i32>>("scalar"),
    ...
    impl GraphQLType for NonNullStringBox1Impl {
        ...
        fn meta<'r>(registry: &mut Registry<'r>) -> MetaType<'r> {
            ...
            registry
                .build_object_type::<Self>(fields)
                .interfaces(&[registry.get_type::<NonNullStringBox1>(),
    ...
    impl GraphQLType for NonNullStringBox2Impl {
        ...
        fn meta<'r>(registry: &mut Registry<'r>) -> MetaType<'r> {
            ...
            registry
                .build_object_type::<Self>(fields)
                .interfaces(&[registry.get_type::<NonNullStringBox2>(),
                              registry.get_type::<SomeBox>()])
                .into_meta()
        }
    }
    ...
    impl GraphQLType for Node {
        ...
        fn meta<'r>(registry: &mut Registry<'r>) -> MetaType<'r> {
            let fields = &[registry.field::<Option<ID>>("id"),
    ...
    impl GraphQLType for QueryRoot {
        ...
        fn meta<'r>(registry: &mut Registry<'r>) -> MetaType<'r> {
            ...
            let fields = &[registry.field::<Option<SomeBox>>("someBox"),
    ...
    fn compatible_return_shapes_on_different_return_types() {
        expect_passes_rule_with_schema(QueryRoot,
                                       factory,
                                       r#"
          {
            someBox {
    ...
    fn reports_correctly_when_a_non_exclusive_follows_an_exclusive() {
        expect_fails_rule_with_schema(QueryRoot,
                                      factory,
                                      r#"
            {
              someBox {
        ...
        "#,
                                      &[RuleError::new(&error_message("other",
                                                                      &Nested(vec![
                            ConflictReason(
                                "scalar".to_owned(),
    ...
    fn disallows_differing_deep_return_types_despite_no_overlap() {
        ...
        "#,
                                      &[RuleError::new(&error_message("box",
                                                                      &Nested(vec![
                            ConflictReason(
                                "scalar".to_owned(),
    ...
    fn compares_deep_types_including_list() {
        ...
        "#,
                                      &[RuleError::new(&error_message("edges",
                                                                      &Nested(vec![
                            ConflictReason(
                                "node".to_owned(),
                                Nested(vec![
