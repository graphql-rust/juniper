...
extern crate log;
use actix_cors::Cors;
use juniper::{tests::{model::Database, schema::Query}, EmptyMutation, EmptySubscription, RootNode, DefaultScalarValue};
use actix_web::{HttpResponse, Error, web, HttpServer, App, middleware};
