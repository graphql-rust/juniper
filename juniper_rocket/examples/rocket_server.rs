...
//
//#[async_trait]
//impl juniper::GraphQLSubscriptionTypeAsync<DefaultScalarValue> for MySubscription
//where
//    MySubscription: juniper::GraphQLType<DefaultScalarValue>,
//    <Self as juniper::GraphQLType<DefaultScalarValue>>::Context: Send + Sync + Clone,
//    <Self as juniper::GraphQLType<DefaultScalarValue>>::TypeInfo: Send + Sync,
//{
//    async fn stream_resolve_field<'a>(
//        &self,
...
//}
//
//impl juniper::GraphQLSubscriptionType<DefaultScalarValue> for MySubscription {
